...
interface LateResubmitProps {
    task: Task;
}

export default function LateResubmit({ task }: LateResubmitProps) {
                            ...
                            <div className="flex items-start gap-4 mb-4">
                                ...
                                <div>
                                    <h2 className="text-2xl font-bold text-foreground flex items-center gap-2">
                                        Late Resubmission Form
                                    </h2>
                                    <p className="text-muted-foreground mt-1">
                                        Submit your task after the deadline
                                    </p>
                                </div>
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="flex justify-end">
                                <Button
                                    ...
                                    className="px-6 py-3 bg-blue-600/90 hover:bg-blue-500 text-white font-medium rounded-lg transition-all focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background shadow-lg"
                                >
