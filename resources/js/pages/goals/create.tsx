...
import { ArrowLeft, LoaderCircle, Target, Flag, Calendar as CalendarIcon, Clock, Users } from 'lucide-react';
...
export default function CreateGoal({ sdg, authUser, staffUsers }: Props) {
    ...
    const submit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        post(GoalController.store().url, {
            onSuccess: () => { toast.success('Goal created successfully.'); reset(); },
            ...
            <div className="min-h-screen py-8 md:py-10">
                <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8 flex items-center justify-between">
                        ...
                        {/* Back button — primary border ghost */}
                        <Link
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="flex min-w-0 flex-1 items-center gap-3">
                                                    {/* 60% primary avatar, 30% secondary initial */}
